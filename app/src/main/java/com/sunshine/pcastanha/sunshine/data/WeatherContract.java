package com.sunshine.pcastanha.sunshine.data;
...
/**
 * Created by pedro.matos.castanha on 6/8/2016.
 * Responsible for creating the agreement between the db schema and the application.
 */
public class WeatherContract {
    //Everything that might be global accessible within the app should be declared inside the Contract class.
    //Table related data should be declared as inner classes and extend BaseColumns class.
    ...
    // device.
    public static final String CONTENT_AUTHORITY = "com.sunshine.pcastanha.sunshine";
